...
architecture behav of cordic is 
    ...
    "cordic,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.232000,HLS_SYN_LAT=96,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=39,HLS_SYN_FF=2574,HLS_SYN_LUT=4898,HLS_VERSION=2019_2}";
    ...
    signal step_fu_205_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal step_reg_274 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal step_0_reg_125 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    icmp_ln37_fu_199_p2 <= "1" when (step_0_reg_125 = ap_const_lv3_5) else "0";
    ...
    step_fu_205_p2 <= std_logic_vector(unsigned(step_0_reg_125) + unsigned(ap_const_lv3_1));
