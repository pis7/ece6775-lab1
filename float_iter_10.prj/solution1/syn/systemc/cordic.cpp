...
void cordic::thread_icmp_ln37_fu_199_p2() {
    icmp_ln37_fu_199_p2 = (!step_0_reg_125.read().is_01() || !ap_const_lv4_A.is_01())? sc_lv<1>(): sc_lv<1>(step_0_reg_125.read() == ap_const_lv4_A);
}
...
void cordic::thread_step_fu_205_p2() {
    step_fu_205_p2 = (!step_0_reg_125.read().is_01() || !ap_const_lv4_1.is_01())? sc_lv<4>(): (sc_biguint<4>(step_0_reg_125.read()) + sc_biguint<4>(ap_const_lv4_1));
}
...
void cordic::thread_zext_ln50_fu_211_p1() {
    zext_ln50_fu_211_p1 = esl_zext<64,4>(step_0_reg_125.read());
}
