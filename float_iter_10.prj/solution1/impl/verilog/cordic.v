...
(* CORE_GENERATION_INFO="cordic,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.232000,HLS_SYN_LAT=191,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=39,HLS_SYN_FF=2576,HLS_SYN_LUT=4899,HLS_VERSION=2019_2}" *)
...
reg   [63:0] reg_193;
wire   [3:0] step_fu_205_p2;
reg   [3:0] step_reg_274;
...
assign icmp_ln37_fu_199_p2 = ((step_0_reg_125 == 4'd10) ? 1'b1 : 1'b0);
...
assign step_fu_205_p2 = (step_0_reg_125 + 4'd1);
